...
import {
  peopleOutline, trophyOutline, folderOutline,
...
@Component({
  ...
  imports: [CommonModule, IonicModule, RouterModule, StatsCardComponent],
...
export class DashboardPage {
  ...
  constructor() {
    addIcons({ peopleOutline, trophyOutline, folderOutline, documentTextOutline, gridOutline });
  }
